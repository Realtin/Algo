...
public class TreeTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("test.getLeft: " + test.getLeft().getContent() + " Key: " + test.getLeft().getContent().getKey());
        System.out.println("test.getRight: " + test.getRight().getContent() + " Key: " + test.getRight().getContent().getKey());
        System.out.println("test.getNachfolgerVon(t):  " + test.getNachfolgerVon(t));
        System.out.println("test.getVorgaengerVon(c):  " + test.getVorgaengerVon(c));
        ...
        System.out.println("test Contains a " + test.contains(a));
        System.out.println("test Contains l " + test.contains(l));
